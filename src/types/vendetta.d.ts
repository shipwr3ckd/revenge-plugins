...
declare module "@vendetta/ui/components" {
    ...
    export const Codeblock: _React.ComponentType<{
        selectable?: boolean;
        style?: _RN.StyleSheetProperties;
        children?: string;
    }>;
    export const Search: _React.ComponentType<{
        onChangeText?: (v: string) => void;
        placeholder?: string;
        style?: _RN.TextStyle;
    }>; // NOTE: I FIXED THIS LETS GOOO WOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOO
